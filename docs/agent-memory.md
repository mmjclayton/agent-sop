...
- solo (2026-07-26): P66 + P70-P73 shipped on branch `fix/p66-p73-validator-and-gate-coherence`. **Not yet pushed or merged.** Batch 0.26 (P67-P69) merged as `e0f9e54` via PR #10. Clear this line once this branch merges.
