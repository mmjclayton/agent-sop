...
- solo (2026-07-26): P67-P69 shipped on branch `docs/p67-p71-digest-and-paper-review` (`842f835`, `9f5ac2c` + housekeeping). **Not yet pushed or merged** — PR still to open. Clear this line once merged.
