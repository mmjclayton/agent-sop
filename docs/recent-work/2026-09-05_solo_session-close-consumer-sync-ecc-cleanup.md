...
**Post-close fix (c38828b).** `scripts/detect-trackers.sh` now excludes `docs/backlog-archive.md`: the archive is Backlog entries moved verbatim, and the close had flagged it as a secondary tracker.
